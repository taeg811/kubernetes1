...
#Запустим artpod.yaml  с двумя контейнерами, опрашивать будем nginx на 80 порту. Сервис ClusterIP получим ip и проросим порт 80:80.
#Будет доступ на машине снаружи кластера 
